...
type ViewAllVaccine = Vaccination & ItemType;
...
const getStatusText = (dueDateString: string | null | undefined) => {
      ...
      <div className="flex items-start">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center mt-1 text-sm text-gray-500">
            ...
            <span>
              Administered:{" "}
              {formatDate(vaccine.administration_date) || "No date"}
            </span>
          </div>
        </div>
        <span
          className={`ml-2 px-2 py-0.5 rounded-full text-xs font-medium ${getStatusBadge(
  ...
  return (
    <>
      ...
      <DetailModal
        ...
        title={selectedVaccine?.vaccination_type?.name || "Vaccination Details"}
      ...
      <ViewAllModal
        ...
        items={vaccines as ViewAllVaccine[]}
