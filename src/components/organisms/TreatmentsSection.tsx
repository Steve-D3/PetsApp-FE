...
import type { TreatmentItem, TreatmentsSectionProps } from "@/features/pets/types/treatment";
import { Calendar, Stethoscope } from "lucide-react";

type ViewAllItem = TreatmentItem & ItemType & {
  id: string | number;
  name: string;
      ...
      >
        <div className="flex items-start">
          <div className="bg-blue-50 p-2 rounded-lg mr-3">
            {treatmentItem.icon || <Stethoscope className="h-5 w-5 text-blue-500" />}
          </div>
  ...
  return (
    <>
      ...
      <DetailModal
        ...
        description={`Administered on ${selectedTreatment?.administered_at || 'unknown date'}`}
